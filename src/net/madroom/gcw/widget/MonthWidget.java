...
//        }
    ...
    public static class MyService extends Service {
        ...
        public void onCreate() {
            ...
            mComponentName = new ComponentName(mContext, MonthWidget.class);
            mType = WidgetConf.TYPE_MONTH;
        ...
        public void onStart(Intent intent, int startId) {
            ...
            int widgetCount = AppWidgetManager.getInstance(mContext).getAppWidgetIds(new ComponentName(mContext, MonthWidget.class)).length;
            if(widgetCount==0) return;

            if(intent!=null && intent.getAction()!=null) {
                if(intent.getAction().equals(WidgetConf.ACTION_CLICK_MONTH)) {
            ...
            clickIntent.setAction(WidgetConf.ACTION_CLICK_MONTH);
            PendingIntent pendingIntent = PendingIntent.getService(mContext, 0, clickIntent, 0);
            mRemoteViews.setOnClickPendingIntent(R.id.month_widget_layout, pendingIntent);
            ...
            Intent alarmIntent = new Intent(mContext, MonthWidget.class);
