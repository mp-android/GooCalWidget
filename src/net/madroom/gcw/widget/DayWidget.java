...
//        }
    ...
    public static class MyService extends Service {
        ...
        public void onCreate() {
            ...
            mComponentName = new ComponentName(mContext, DayWidget.class);
            mType = WidgetConf.TYPE_DAY;
        ...
        public void onStart(Intent intent, int startId) {
            ...
            int widgetCount = AppWidgetManager.getInstance(mContext).getAppWidgetIds(new ComponentName(mContext, DayWidget.class)).length;
            if(widgetCount==0) return;

            if(intent!=null && intent.getAction()!=null) {
                if(intent.getAction().equals(WidgetConf.ACTION_CLICK_DAY)) {
            ...
            clickIntent.setAction(WidgetConf.ACTION_CLICK_DAY);
            PendingIntent pendingIntent = PendingIntent.getService(mContext, 0, clickIntent, 0);
            mRemoteViews.setOnClickPendingIntent(R.id.day_widget_layout, pendingIntent);
            ...
            Intent alarmIntent = new Intent(mContext, DayWidget.class);
